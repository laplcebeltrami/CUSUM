...
%% ------------------------------
%% Example 1: CUSUM for white noise without any change point
...
%Fractal computation
observed = higuchi(pos, 10); %Higucci fractal computation
title(['CUSUM         FD=', num2str(observed)])
ylim([-50 50])
...
%% ------------------------------
%% Example 2: CUSUM for signal with one change point
rng(42);
n = 1000;
y = randn(n, 1);
...
%% ------------------------------
%% Example 3: CUSUM for signal with two change point
rng(42);
n = 1000;
y = randn(n, 1);
